        ...
        <div class="row">
            <div class="col-md-5 alert alert-dark">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="quantidadeTextBox" runat="server" CssClass="form-control"></asp:TextBox>
                    <asp:RangeValidator ID="quantidadeRangeValidator" runat="server" CssClass="text-danger" 
                        ErrorMessage="A quantidade deve ser entre 1 e 100"
                        ControlToValidate="quantidadeTextBox" Display="Dynamic" MinimumValue="1" 
                        MaximumValue="100" Type="Double">
                    </asp:RangeValidator>
                </div>

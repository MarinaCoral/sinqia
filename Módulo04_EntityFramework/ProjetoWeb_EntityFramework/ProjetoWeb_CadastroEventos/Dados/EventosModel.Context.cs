...
namespace ProjetoWeb_CadastroEventos.Dados
{
    ...
    public partial class EventosEntities : DbContext
    {
        ...
        public virtual int pr_icluir_convidado(string cpf, Nullable<int> idevento, string nome, string telefone, string email, ObjectParameter status)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pr_icluir_convidado", cpfParameter, ideventoParameter, nomeParameter, telefoneParameter, emailParameter, status);
        }
    }
}
